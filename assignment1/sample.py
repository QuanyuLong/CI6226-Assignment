...
def getSortedBlockNames():
    ...
    blockNames_pos = [(blockName, blockName) for blockName in blockNames]  # (Block id, names)
...
def invert_block(docs, blockCapacityLimit=1000):
    ...
    for doc in docs:
        ...
        for term in doc.split(' '):
            ...
            if term != '' and not term in terms_in_doc:
